...
/**
 * Signs in with Google. For a guest (anonymous) session this upgrades it in
 * place — Better Auth creates the real account and replaces the anonymous user.
 * After the OAuth round-trip the cross-domain plugin hands the session back and
 * `/` routes on into the app.
 */
